...
<form method="post" action="../api/WebPaySign.php" id="paySignForm">
    ...
    <ul class="form-wrap" id="J-form-wrap">
        ...
        <li class="form-item form-item-border clearfix">
            ...
            <div class="form-field">
                <input type="text"  name="version" value="3.0" autocomplete="off"
        ...
        <li class="form-item form-item-border clearfix">
            ...
            <div class="form-field">
                <input type="text" class="" name="specBankCardNo" 
                	autocomplete="off" placeholder="请输入银行卡号" data-callback="input.status"/>
                <span class="clear-btn J-clear-btn">×</span>
            </div>
        </li>
        <li class="form-item form-item-border clearfix">
            ...
            <div class="form-field">
                <input type="text" class="" name="specIdCard"
                	autocomplete="off" placeholder="请输入身份证号" data-callback="input.status"/>
                <span class="clear-btn J-clear-btn">×</span>
            </div>
        </li>
        <li class="form-item form-item-border clearfix">
            ...
            <div class="form-field">
                <input type="text" class="" name="specName" 
                	autocomplete="off" placeholder="请输入姓名" data-callback="input.status"/>
                <span class="clear-btn J-clear-btn">×</span>
            </div>
        </li>
