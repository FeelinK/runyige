        ...
        <div class="content">
            ...
            <div class="footer">
                ...
                <div class="f-top">
                    ...
                    <input type="button" value="下载" id="xiazaiyue">
...
<script>
    $(document).on("click",".doctor_name",function(){
        ...
        $.ajax({
            url:'index.php?r=user/doctordatayuetwo',
            type:'get',
...
<!--下载-->
<script>
    $(document).on("click","#xiazaiyue",function(){
        hospital_name=$(".hospital_name").attr("value")
        location.href='index.php?r=user/downfour&hospital_name='+hospital_name
    })
</script>
<!--日度别-->
<script>
    $(document).on("click",".ri",function(){
        hospital_name=$(".hospital_name").attr("value")
        location.href='index.php?r=user/doctordata&hospital_name='+hospital_name
    })
</script>
<!--根据英文字母匹配数据-->
<script>
