...
class TblProgressBoiling extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['progress_id', 'p_prescription_id_check', 'p_soaking_time', 'b_prescription_id_check', 'b_piece_check', 'b_kinds_check', 'b_appearance_check', 'b_water_yield', 'b_boiling_time', 'b_boiling_machine_number', 'b_pre_boiling', 'b_post_boiling', 'a_prescription_id_check', 'a_soup_appearance_check', 'a_quantity_check', 'decocting_machine', 'password_hash'], 'integer'],
            [['b_pressure'], 'number'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'decocting_machine' => 'Decocting Machine',
